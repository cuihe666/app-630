Zepto(document).ready(function() {
	...
	var checkIos = function () {
		...
		if(isIOS){
			...
			$('.thm_list_wp').css("margin-top","3.1rem");
		}
	}
	...
	var onEvyThmTap = function() { //TODO跳转至详情页
		...
		//console.log(tid);
		window.location.href = 'theme_detail.html?tid='+tid+'&item_type=3&from_app=master_theme.html';
	};
	...
	var getLineList = function(json_data,zc_dropload) { //TODO
		var ajax_url = http_url+'/api/theme/higolist';
		$.ajax({
			url:ajax_url,
			data:json_data,
			type:'get',
